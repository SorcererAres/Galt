...
///
/// 取自 k2-fsa/sherpa-onnx v1.13.3 官方 Swift 包装层。
/// 整体由 GALT_SHERPA 门控：关闭时此文件编译为空，不依赖二进制框架。

#if GALT_SHERPA
import Foundation  // For NSString
import CSherpaOnnx  // Vendor/sherpa-onnx.xcframework 的 C-API 模块（SPM modulemap 暴露）
